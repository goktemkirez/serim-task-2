...
namespace ServiceReference2
{
    ...
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<ServiceReference2.KPSPublicSoap>, ServiceReference2.KPSPublicSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ServiceReference2.TCKimlikNoDogrulaResponse> ServiceReference2.KPSPublicSoap.TCKimlikNoDogrulaAsync(ServiceReference2.TCKimlikNoDogrulaRequest request)
        {
            return base.Channel.TCKimlikNoDogrulaAsync(request);
        }
        
        public System.Threading.Tasks.Task<ServiceReference2.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili)
        {
            ServiceReference2.TCKimlikNoDogrulaRequest inValue = new ServiceReference2.TCKimlikNoDogrulaRequest();
            inValue.Body = new ServiceReference2.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            return ((ServiceReference2.KPSPublicSoap)(this)).TCKimlikNoDogrulaAsync(inValue);
        }
